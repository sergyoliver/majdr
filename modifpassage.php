            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        if (isset($_GET['id'])){
                            $idpa = $_GET['id'];
                            $rspm = $bdd->prepare('select * from passage_periodes where id = :d ');
                        ...
                        if (isset($_POST['ok'])){
                            ...
                            $rsp = $bdd->prepare("select * from passages where type_pied = :t  and  type_periode = :p and  libelle = :l ");
                            ...
                            $rsql1 = $bdd->prepare('UPDATE  passage_periodes SET passage_id=:passage_id, numero_passage=:numero_passage, libelle =:libelle, type_pied=:type_pied,
type_periode=:type_periode,date_debut=:date_debut,date_fin=:date_fin,date_modification=:date_modification,id_modification=:id_modification,campagne=:campagne,active=:active,nump=:nump
                               WHERE id = :id ');


                            $tab = $rsql1->execute((array('passage_id' => $idpassage,'numero_passage' => $_POST['nump'], 'libelle' => $_POST['lib'], 'type_pied' => $_POST['culture'], 'type_periode' => $_POST['periode'],
                                    'date_debut' => formatinv_date($_POST['datedebut']),'date_fin'=> formatinv_date($_POST['datefin']),'date_modification'=> gmdate("Y-m-d H:i:s"),
                                    'id_modification'=> $_SESSION['id'], 'campagne' => $_POST['campagne'],'active'=> $_POST['actif'],'nump'=>$_POST['numordre'],'id'=>$idpa)));
                        ...
                        <form class="form-horizontal login_validator" id="form_inline_validator" action=""  method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 input_field_sections">
                                    <h5>Numero passage </h5>
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="1-10" name="numordre" id="numordre" value="<?php if($rowpm['nump']){ echo $rowpm['nump']; } ?>">
                                        <span class="input-group-addon"> <i class="fa fa-location text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="nump" id="nump"  >
                                           ...
                                           for($i=1; $i<7;$i++){
                                                ?>
                                                <option <?php if($rowpm['numero_passage']==$i){ echo 'selected'; } ?>  value="<?php echo $i ?>"><?php echo $i ?></option>
                                ...
                                <div class="col-lg-12 input_field_sections">
                                    ...
                                    <div class="col-lg-7 push-lg-4">
                                        ...
                                        <label for="radio3" class="custom-control custom-radio signin_radio3">
                                            <input id="radio3" name="actif" type="radio" class="custom-control-input" value="1"  <?php if($rowpm['active']=='1'){ echo 'checked'; } ?>>
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Activé </span>
                                        </label>
                                        <label for="radio4" class="custom-control custom-radio signin_radio4">
                                            <input id="radio4" name="actif" type="radio" class="custom-control-input" value="0" <?php if($rowpm['active']=='0'){ echo 'checked'; } ?>>
                                            <span class="custom-control-indicator"></span>
