    ...
    <div class="main-bar row">
        <div class="col-sm-5 col-lg-6 skin_txt">
            <h4 class="nav_top_align">
               ...
               Formulaire de mise à jour de parcelle
            </h4>
        </div>
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="active breadcrumb-item">Mise à jour parcelle</li>
            </ol>
        </div>
    </div>
</header>
                            ...
                            <div class="row">
                                <div class="col-lg-4 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input readonly type="text" style="background-color: #8fdf82; font-weight: bold;color: black" class="form-control" name="codep" value="<?php echo $rowpm['code_parcelle'] ?>">
                                ...
                                <div class="col-lg-12 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="prod" id="prod"  >
                                            ...
                                            <?php
                                            $p=1;
                                            $rsprod = $bdd->prepare('select * from producteurs  ORDER BY nom ASC ');
                                            $rsprod->execute();
                                            while($rowprod = $rsprod->fetch()) {
                                                ?>
                                                <option value="<?php echo $rowprod['code_producteur'] ?>"  <?php if ($rowpm['code_producteur']==$rowprod['code_prod']) echo 'selected' ; ?>><?php echo $rowprod['nom'] ?></option>
...
<!--                                    <span style="text-align: center"><a href="?page=ajoutproducteur" target="_blank">Ajouter nouveau producteur</a><a class="fa fa-plus"></a></span>-->
                                ...
                                <div class="col-lg-4 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="vil" id="vil" >
                                            ...
                                            <?php
                                           echo  $code=$rowpm['departement_code'];
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 input_field_sections">
                                    <h5>Longitude</h5>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="long" <?php if (empty($rowpm['longitude'])){ }else{echo 'readonly'; }  ?>  id="long" value="<?php echo $rowpm['longitude'] ?>">
                                        <span class="input-group-addon"> <i class="fa fa-location text-primary"></i>
                                        </span>
                                    </div>
                                    ...
                                    <h5>Latitude</h5>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="lat" <?php if (empty($rowpm['latitude'])){ }else{echo 'readonly'; }  ?> id="lat" value="<?php echo $rowpm['latitude'] ?>">
                                        <span class="input-group-addon"> <i class="fa fa-location text-primary"></i>
                                        </span>
                                    </div>
                                </div>
