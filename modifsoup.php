    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="active breadcrumb-item">Modifier sous prefecture</li>
            </ol>
        </div>
    </div>
</header>
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        if(isset($_GET['id'])){
                            ...
                            try{
                                $id = $_GET['id'];
                                $rsa = $bdd->prepare('select * from sous_prefectures where  id = :j2');
                    ...
                    // je verifie si la com n existe pas
                            ...
                            $rs = $bdd->prepare('select * from sous_prefectures where departement_code = :d and  designation = :l');
                            $rs->execute(array("d" => $_POST['dep'],"l" => $com));
                            $nb = $rs->rowCount();
                            if ($nb==0){
                                try {


                                    $rsql1 = $bdd->prepare('UPDATE  sous_prefectures SET  designation = :designation, departement_code = :departement_code
                                                       WHERE id = :id ');
                                    $tab = $rsql1->execute(array('designation' => $com,'departement_code' => $_POST['dep'], 'id' => $id));
                                ...
                                echo '<span style="color: red; font-size: 17px">Cette Sous préfecture existe  deja !!!</span>';
                            }
                                ...
                                <div class="col-lg-4 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="del" id="role" onchange="check_dep(this.value)" >
                                            ...
                                            $rsdep1->execute(array("d"=>$rowa['departement_code']));
