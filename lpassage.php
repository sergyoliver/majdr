                ...
                <div class="card m-t-35">
                    ...
                    <div class="card-block m-t-35">
                        <table id="example1" class="display table table-stripped table-bordered">
                            ...
                            <?php
                            $i=1;
                            $rsg = $bdd->prepare('select *,passage_periodes.type_pied as c,passage_periodes.id as idp, passage_periodes.libelle as lib from passage_periodes,passages WHERE passage_id =passages.id and  passage_periodes.supp=0 ORDER by passage_periodes.id DESC ');
                            $rsg->execute();
                            while($rowg = $rsg->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php if (isset($rowg['active']) and $rowg['active']==1 ){ echo '<span style="color: green; font-weight: bold">Activé</span>'; }else{echo '<span style="color: red">Désactivé</span>'; }  ?></td>
                                    <td style="background-color: #c9c376"><?php echo $rowg['nump']; ?></td>
                                    <td>
